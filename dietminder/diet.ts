...
var val = (<HTMLInputElement>document.getElementById("myval")).value;
sum[p] = 0;
...
function adder(){
var food = (<HTMLInputElement>document.getElementById("food")).value;
var cal = (<HTMLInputElement>document.getElementById("cal")).value;
sum[i] = cal;
i = i+1;
